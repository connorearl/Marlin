...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_XY 0.004       // (steps or mm) Steps or millimeter distance for each XY babystep
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.9    // Unit: mm compression per 1mm/s extruder speed
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Handy Dandy Commands"
  ...
  #define MAIN_MENU_ITEM_4_DESC "Heat Bed/Home/Level for " PREHEAT_1_LABEL
  #define MAIN_MENU_ITEM_4_GCODE "M190 R" STRINGIFY(PREHEAT_1_TEMP_BED) "\nG4 S60\nG28\nG29\nM500\nG28\nM140 S0"
